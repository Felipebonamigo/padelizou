...
2. **Já existe algo equivalente aqui?** São 35 controllers (em 76 arquivos — muitos são classes parciais) e ~7.530 testes — reimplementar o
...
dotnet test Padelizou.slnx -c Release --no-build --nologo   # ~1min15, ~7.530 testes
...
sozinho. Quem mexer em JS com conferidor roda antes de commitar — hoje são **12**, e o glob
...
- **Todo defeito corrigido vira teste de regressão** — é assim que a suíte foi de ~1000 pra
  ~7.530 testes, e é o que faz o STATUS.md confiável: se algo quebrou antes, tem teste hoje.

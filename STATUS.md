...
> Última atualização: **29/07/2026 (fim da noite)** — as 5 decisões do Felipe de monetização e produto: condição dos 5% escrita na escolha, **taxa do torneio pela forma que o jogador paga** (10% no Pix mesmo em "todas as formas"), **painel do clube**, "Quero meu clube aqui" e **nome completo + acompanhantes na aula**. Custo real da aula medido (~R$ 1; margem de 77–92% a 10%). **build-127**, **634 testes**, publicado em dev e prod.

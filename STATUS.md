...
> Última atualização: **08/08/2026 (dia do lançamento)** — 🔴 **TORNEIO AO VIVO NA MÃO: a tela de Jogos parou de se recarregar sozinha (`build-392-04b068e`, publicado com as gurias em quadra).**
>
...
>
> 🚀 **Publicado em produção no meio do torneio, e vale saber como**: o `deploy.yml` é **`workflow_dispatch`** — o push **não** publica sozinho, o CI só empacota. Com as jogadoras em quadra, o deploy foi disparado por SSH com o mesmo comando do workflow (`/opt/padelizou-deploy/deploy.sh prod build-392-04b068e`). ✅ Conferido no ar: `/js/jogos-abas.js` 200 (era 404), a página do torneio 23 servindo os dois scripts com `?v=` novo, `healthz` 200, **0 reinício**. **2.634 testes.**
>

...
- **16 elogios de padel** (eram 8) e **12 conquistas** (eram 6). Elogios novos pensando no que só existe no padel: Boa Víbora, Boa Chiquita, **Saída de Parede** (a parede é metade do jogo), Mão Macia, Leitura de Jogo, Rápido na Quadra, Garra e Fair Play. Conquistas novas todas calculadas do que já existe no banco: Veterano (5 torneios), 10 Vitórias, Finalista, Bicampeão, **Querido da Quadra** (5 elogios recebidos — cruza as duas features) e Aluno Aplicado (3 aulas). Regra saiu do `EstatisticasService` pro `CatalogoConquistas` (puro): lá se coleta, aqui se decide. **Campeão implica Finalista.** Conquista bloqueada virou META: ganhou `Descricao` ("Dispute 5 torneios") no lugar do "bloqueado" mudo. Total fecha em 12 = 3 fileiras exatas de 4, **com teste prendendo o número**.
- **Avaliação do professor em nota 0–10** (era 1–5 estrelas), como o Felipe pediu — mesma escala do canal de opinião. A migração **converte as notas antigas ×2** (5★ = 10; sem isso um professor 5 estrelas viraria "5/10", nota de reprovação, da noite pro dia). Elegibilidade não mudou: só avalia quem teve aula Realizada, uma avaliação por aluno, editável.

...
public class CompartilharListaDeJogosTests
{
    ...
    public void A_lista_espelha_a_fila_da_tela_com_as_mesmas_etiquetas()
    {
        ...
        var fila = OrdemNoHorario.Ordenar(new[] { jogo }, new[] { Previa(Sabado) }, new Dictionary<(int, int), DateTime>());
    ...
    public void Dupla_sem_parceiro_diz_parceiro_nas_duas_formas()
    {
        ...
        var lista = ListaDeJogos.Montar(OrdemNoHorario.Ordenar(new[] { jogo }, Array.Empty<JogoQueVem>(), new Dictionary<(int, int), DateTime>()), null, false);

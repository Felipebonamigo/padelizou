...
public class FiltroDeCidadeNoRankingTests
{
    ...
    {
        // ⚠️ Teste-guarda de uma DECISÃO, não de um bug (Felipe, 10/08/2026). Quem ler a
        // consulta acima vai achar que falta um `!j.PerfilPrivado` e "consertar".
        //
        // 📌 Este comentário já dizia que a busca de jogadores fazia o contrário (escondia
        // quem era privado). Fazia, por um engano que durou algumas horas e foi revertido: a
        // chave é sobre CONTATO — Instagram e WhatsApp —, não sobre resultado de padel. As
        // duas telas seguem a MESMA régua, e é a desta aqui.
        //
